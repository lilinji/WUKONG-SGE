...
# https://github.com/lilinji/hpc-sdk2.git
...
####install python 2.7 run 
#### clear packages
sh install_python.sh 

###########01  Creat conf json

/usr/local/bin/python2.7 modfiy_conf_json.py -c compute -f gridengine -k 1 -m master -p Novo2017 
sleep 10
echo "install  HPC-CLUSTER.........."
/usr/local/bin/python2.7 digger.py -c hpc-sge.json
